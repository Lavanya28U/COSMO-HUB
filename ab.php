...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        ...
        <select id="celestial_body" name="celestial_body">
            ...
            $sql = "SELECT id, name FROM celestial_bodies where type like 'black hole'";
        ...
        <label for="spectral_class">Spectral Class:</label><br>
        <input type="text" id="spectral_class" name="spectral_class"><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO black_holes (id,name, mass, size, spectral_class, description) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("isddss", $celestial_body_id, $celestial_body_name, $mass, $size, $spectral_class, $description);
    ...
    <script>
        function clearForm() {
            ...
            document.getElementById("spectral_class").value = "";
