...
<body>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
        ...
        <select id="celestial_body" name="celestial_body">
            ...
            $sql = "SELECT id, name FROM celestial_bodies where type like 'comet'";
        ...
        <label for="comet_text">Comet Text:</label><br>
        <input type="text" id="comet_text" name="comet_text"><br>
        
        
        <label for="time_stamp">Time Stamp:</label><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("INSERT INTO comet (comet_id,name, comet_text, time_stamp) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("isss", $celestial_body_id, $celestial_body_name, $comet_text, $time_stamp);
    ...
    <script>
        function clearForm() {
            ...
            document.getElementById("comet_text").value = "";
